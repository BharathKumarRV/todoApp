 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * @SpringBootTest public class PassEncodingTest {
		 * 
		 * public static BCryptPasswordEncoder passwordEncoder = new
		 ...
		 * 
		 * String pass=passwordEncoder.encode(password_); System.out.println(pass);
